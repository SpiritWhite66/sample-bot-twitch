package io.bot.personnal.application.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("sampleBotTwitch");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("sampleBotTwitch");
        ...
        config.getMapConfigs().put("io.bot.personnal.application.domain.*", initializeDomainMapConfig(jHipsterProperties));
